...
from src.ingestion_api.schemas import BatchIngestRequest, IngestRequest, IngestResponse, StreamIngestRequest
...
def ingest(
    ...
    """Primary ingestion endpoint for smartwatch time-series events."""
